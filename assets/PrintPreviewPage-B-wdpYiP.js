import{u as m,j as a,y as c,b1 as h,h as l}from"./index-7jDGGr-d.js";import{K as o}from"./KopSurat-BHSqmyDp.js";import{P as x}from"./PenandatanganDokumen-C3i1fPOm.js";import{A as p}from"./arrow-left-BZWbkiYz.js";import{P as g}from"./printer-BHS6kxRX.js";import"./formatGelar-DvtJTrhG.js";const u=({children:i,title:s="Dokumen Resmi",showSignature:e=!0,showGuruSignature:n=!0,signatureMode:r="default"})=>{const{settings:t}=m(),d=t.general||{};return a.jsxs("div",{className:"max-w-4xl mx-auto p-8 bg-white min-h-screen print:p-0 print:m-0 print:shadow-none print:w-full",children:[a.jsx(o,{}),a.jsxs("div",{className:"text-center mb-8",children:[a.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-2",children:s}),a.jsx("p",{className:"text-gray-600",children:d.school_name||"Si@Kad"})]}),a.jsx("div",{className:"mb-8",children:i}),e&&a.jsx(x,{mode:r,showGuru:n}),a.jsx("style",{dangerouslySetInnerHTML:{__html:`
        @media print {
          @page {
            margin: 2cm;
            size: A4;
