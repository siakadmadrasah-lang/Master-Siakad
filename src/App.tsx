...
import { PrintSecurityProvider } from "@/contexts/PrintSecurityContext";
...
const PembiasaanPublic = lazy(() => import("./pages/PembiasaanPublic"));
const LCKHPublic = lazy(() => import("./pages/LCKHPublic"));
...
const PortalPengisianGTK = lazy(() => import("./pages/PortalPengisianGTK"));
...
const RuangGuruAdmin = lazy(() => import("./pages/admin/RuangGuruAdmin"));
              ...
              <TooltipProvider>
                ...
                <BrowserRouter>
                  ...
                  <Routes>
                    ...
                    <Route path="/galeri" element={<Index />} />
                    <Route path="/galeri/*" element={<Index />} />
                    <Route path="/pengumuman" element={<Index />} />
                    <Route path="/pengumuman/*" element={<Index />} />
                    ...
                    <Route path="/data-gtk" element={<TeachersList />} />
                    <Route path="/gtk" element={<TeachersList />} />
                    <Route path="/data-guru" element={<TeachersList />} />
                    <Route path="/direktori-gtk" element={<TeachersList />} />
                    ...
                    <Route path="/pembiasaan" element={<PembiasaanPublic />} />
                    <Route path="/laporan-pembiasaan" element={<PembiasaanPublic />} />
                    <Route path="/lckh" element={<LCKHPublic />} />
                    <Route path="/lckh-publik" element={<LCKHPublic />} />
                    <Route path="/catatan-kegiatan-guru" element={<LCKHPublic />} />
                    <Route path="/cetak-lckh" element={<LCKHPublic />} />
                    {/* Ruang Kerja Guru / Portal Pendidik Mandiri */}
                    <Route path="/ruang-guru" element={<RuangGuruPublic />} />
                    <Route path="/portal-guru" element={<RuangGuruPublic />} />
                    ...
                    <Route path="/prestasi" element={<PrestasiPublic />} />
                    <Route path="/prestasi-siswa" element={<PrestasiPublic />} />
                    <Route path="/data-prestasi-publik" element={<PrestasiPublic />} />
                    <Route path="/kejuaraan" element={<PrestasiPublic />} />
                    {/* Portal Pengisian GTK / Guru Mandiri via GSheet */}
                    <Route path="/portal-pengisian-gtk" element={<PortalPengisianGTK />} />
                    <Route path="/isi-gtk" element={<PortalPengisianGTK />} />
                    <Route path="/form-gtk" element={<PortalPengisianGTK />} />
                    <Route path="/pengisian-gtk" element={<PortalPengisianGTK />} />
                  ...
                  <Route path="/admin/ruang-guru" element={<RuangGuruAdmin />} />
                  <Route path="/admin/portal-guru" element={<RuangGuruAdmin />} />
                  ...
                  <Route path="/admin/pembiasaan" element={<PembiasaanAdmin />} />
                  <Route path="/admin/laporan-pembiasaan" element={<PembiasaanAdmin />} />
