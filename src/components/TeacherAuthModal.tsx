...
const TeacherAuthModal: React.FC = () => {
  ...
  return (
    <Dialog open={isTeacherModalOpen} onOpenChange={open => !open && closeTeacherModal()}>
      <DialogContent className="max-w-md p-0 overflow-hidden border-0 shadow-2xl rounded-3xl bg-white">
        {/* Header decoration */}
        <div className="relative p-6 sm:p-7 bg-gradient-to-br from-emerald-700 via-teal-800 to-slate-900 text-white overflow-hidden">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <DialogTitle className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
                  Ruang Kerja Guru
                  <span className="px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-emerald-500/40 text-emerald-100 rounded-full border border-emerald-400/30">
                    Kredensial GTK
                  </span>
                </DialogTitle>
                <DialogDescription className="text-xs text-emerald-100/90 mt-0.5">
                  {activeMadrasah?.nama || 'Madrasah'} • Akses Mandiri Administrasi & Dokumen
                </DialogDescription>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-semibold text-emerald-700">
                  {teachersList.length} GTK Terdaftar
                </span>
              </div>
