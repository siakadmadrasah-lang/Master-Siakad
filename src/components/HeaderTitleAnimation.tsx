...
export const getFontClassName = (fontKey?: string) => {
  switch (fontKey) {
    ...
    case 'serif-italic': return 'font-serif italic font-bold pr-1.5 inline-block';
    case 'sans-italic': return 'font-sans italic font-semibold pr-1 inline-block';
    ...
    case 'handwritten': return 'font-serif italic font-normal tracking-wide pr-1.5 inline-block';
...
export const getColorStyleAndClass = (colorKey?: string, defaultFallback: string = 'text-slate-900') => {
  ...
  if (colorKey === 'gradient-emerald') {
    return {
      className: 'text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 font-bold',
      style: {}
    };
  }
  if (colorKey === 'gradient-amber') {
    return {
      className: 'text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-amber-500 to-yellow-600 font-bold',
      style: {}
    };
  }
  if (colorKey === 'gradient-cyan') {
    return {
      className: 'text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-teal-600 to-blue-600 font-bold',
      style: {}
    };
  }
  if (colorKey === 'gradient-purple') {
    return {
      className: 'text-transparent bg-clip-text bg-gradient-to-r from-purple-700 via-fuchsia-600 to-pink-600 font-bold',
      style: {}
    };
  }
