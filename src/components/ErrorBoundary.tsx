...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // Detect dynamic chunk import failures or React module version mismatch and automatically perform a recovery reload once
    ...
    const isHookOrContextMismatch = msg.includes('invalid hook call') ||
