...
const DocumentCover = ({ 
  ...
  const displayMadrasah = nama_madrasah || (activeMadrasah as any)?.nama_resmi || identitas.nama_resmi || activeMadrasah?.nama_madrasah || identitas.nama_madrasah || general.school_name || 'Si@Kad Madrasah';
