...
const CetakPiagamPrestasiModal: React.FC<CetakPiagamModalProps> = ({
  ...
  const namaMadrasah = (activeMadrasah as any)?.nama_resmi || identitas.nama_resmi || activeMadrasah?.nama_madrasah || identitas.nama_madrasah || settings.general?.school_name || 'Madrasah Ibtidaiyah';
              ...
              <div className="text-left">
                {item.pembimbing && (
                  <div className="space-y-0.5">
                    ...
                    <p className="font-bold text-slate-800 underline">{formatFullNameWithTitles(item.pembimbing)}</p>
                  </div>
                )}
              </div>
              ...
              <div className="w-64 text-center">
                ...
                <div className="relative inline-block">
                  ...
                  <p className="font-bold text-slate-900 underline tracking-wide">
                    {formatOfficialSignatureName(kepala.nama)}
                  </p>
                </div>
