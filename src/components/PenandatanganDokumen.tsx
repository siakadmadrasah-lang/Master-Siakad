...
const PenandatanganDokumen = ({ 
  ...
  const rawKepalaNama = customKepala?.nama || penandatangan.kepala_nama || identitas.nama_pimpinan || activeMadrasah?.nama_pimpinan || settings.general?.headmaster_name || '[Nama Kepala Madrasah]';
  const kepala = {
    nama: formatOfficialSignatureName(rawKepalaNama),
  ...
  const rawPanitiaNama = penandatangan.ketua_panitia_nama || '[Nama Ketua Panitia]';
  const panitia = {
    nama: formatOfficialSignatureName(rawPanitiaNama),
      ...
      <div className="mt-12 grid grid-cols-2 gap-12 text-[11pt] font-serif">
        <div className="text-center">
          ...
          <div className="relative inline-block">
            ...
            <p className="font-bold underline">{kepala.nama}</p>
          </div>
          <p>NIP. {kepala.nip}</p>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="relative inline-block">
            ...
            <p className="font-bold underline">{panitia.nama}</p>
          </div>
          <p>NIP. {panitia.nip}</p>
        </div>
      </div>
  ...
  if (customGuru && !isPlaceholderName(customGuru.nama)) {
    ...
    selectedGuru = {
      nama: formatOfficialSignatureName(customGuru.nama),
      nip: guruNip || '-',
    ...
    selectedGuru = {
      nama: formatOfficialSignatureName(currentTeacher.nama),
    ...
    if (classNum) {
      ...
      if (matched) {
        selectedGuru = {
          nama: formatOfficialSignatureName(matched.nama),
          nip: matched.nip || '-',
        ...
        <>
          <div className="text-center">
            ...
            <div className="relative inline-block">
              ...
              <p className="font-bold underline leading-tight">{kepala.nama}</p>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="relative inline-block">
              ...
              <p className="font-bold underline leading-tight">{guru.nama}</p>
            </div>
