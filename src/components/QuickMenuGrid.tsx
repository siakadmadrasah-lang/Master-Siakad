...
const menuItems: MenuItem[] = [
  {
    ...
    href: '/teachers',
    icon: UserCheck,
    color: 'text-teal-700 group-hover:text-teal-800',
    bgColor: 'bg-teal-100 text-teal-700 group-hover:bg-teal-700 group-hover:text-white'
  },
  {
    name: 'Prestasi Siswa',
    href: '/prestasi',
    ...
    bgColor: 'bg-amber-100 text-amber-700 group-hover:bg-amber-700 group-hover:text-white'
  },
  {
    name: 'Ruang Guru',
    href: '/ruang-guru',
  ...
  },
  {
    ...
    bgColor: 'bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white'
  },
  {
    name: 'Kelas & Siswa',
    href: '/students-list',
