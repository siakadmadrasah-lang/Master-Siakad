            ...
            <div className="relative rounded-3xl overflow-hidden border-4 border-white shadow-2xl bg-slate-900 group">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-3.5 sm:p-4 rounded-2xl border border-white/80 shadow-xl flex items-center justify-between z-10 overflow-hidden">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  {/* Title Runs (Typewriter), Description Stays Static */}
            ...
            {activeTab === 'profile' && (
              <div className="space-y-4 animate-in fade-in duration-300">
                ...
                <div className="pt-2 flex flex-wrap items-center gap-3">
                  <a 
                    href={about.cta_primary_link || '#programs'} 
                  ...
                  >
                    <span>{about.cta_primary_label || 'Lihat Program Unggulan'}</span>
                    <ArrowRight className="w-3.5 h-3.5 text-emerald-400" />
                  </a>

                  <a 
                    href={about.cta_secondary_link || '/spmb'} 
                  ...
                  >
                    <span>{about.cta_secondary_label || 'Pendaftaran SPMB Online'}</span>
