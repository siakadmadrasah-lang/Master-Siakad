...
export const SiteSettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchSettings = useCallback(async () => {
    try {
      ...
      if (identitas) {
        if (identitas.nama_madrasah && (!settingsMap.general?.school_name || settingsMap.general.school_name === 'Si@Kad')) {
          settingsMap.general = settingsMap.general || {};
          settingsMap.general.school_name = identitas.nama_madrasah;
        }
