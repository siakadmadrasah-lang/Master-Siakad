...
import {
  Printer, Copy, Save, HeartHandshake, BookOpen, User, Calendar,
  Sparkles, ArrowLeft, Plus, Trash2, Eye, Sliders, Layers, Check
} from 'lucide-react';
import { showSuccess, showError } from '@/utils/toast';
import { RPPKarakterData } from '@/pages/admin/kurikulum/RPPKarakter';
...
export default function RPPKarakterPublic() {
  ...
  const handleDeleteRPP = (id: string) => {
    if (!window.confirm('Hapus RPP Karakter ini dari arsip?')) return;
...
1. Pendahuluan (${formData.pendahuluan_waktu}):
${formData.pendahuluan_kegiatan}

2. Inti (${formData.inti_waktu}):
${formData.inti_kegiatan}

3. Penutup (${formData.penutup_waktu}):
${formData.penutup_kegiatan}

G. ASESMEN & PENILAIAN KARAKTER
- Sikap       : ${formData.teknik_penilaian_sikap}
- Pengetahuan : ${formData.teknik_penilaian_pengetahuan}
- Keterampilan: ${formData.teknik_penilaian_keterampilan}
...
Guru Pengampu  : ${formData.nama_guru} (NIP: ${formData.nip_guru})
    ...
    showSuccess('Teks RPP Karakter berhasil disalin!');
  };

  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      <SEO
        title="RPP Karakter - Si@Kad Madrasah"
        description="Penyusunan RPP Berkarakter Resmi Penguatan Pendidikan Karakter (PPK) & P5-PPRA Kemenag RI"
      />
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">
                    Modul Mandiri Pendidik untuk Merancang Pembelajaran Berkarakter & Akhlak Mulia
                  </p>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'editor' && (
          <div className="space-y-6 print:hidden">
              ...
              <div className="space-y-3 bg-gradient-to-br from-indigo-50/80 via-purple-50/40 to-slate-50 p-4 sm:p-5 rounded-2xl border border-indigo-100">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <span className="text-[11px] text-slate-500 italic">
                    Ketik topik atau pilih inspirasi materi, lalu klik tombol Generate
                  </span>
                </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-xs font-bold text-slate-700 block">
                  B. Profil Pelajar Rahmatan lil 'Alamin (Kemenag RI):
                </label>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Pembiasaan Karakter Harian</label>
                <Textarea
                  rows={2}
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
              <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900">Tujuan Pembelajaran Berbasis Karakter</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-emerald-800">1. Tujuan Sikap Spiritual</label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-blue-800">2. Tujuan Sikap Sosial</label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-indigo-800">3. Tujuan Pengetahuan</label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-purple-800">4. Tujuan Keterampilan / Aksi Nyata</label>
                  <Textarea
                    rows={2}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Uraian Materi Pokok</label>
                  <Textarea
                    rows={2}
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5 md:col-span-1">
                  <label className="text-xs font-bold text-slate-700">Media / Alat</label>
                  <Input
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
              <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900">Langkah Kegiatan Pembelajaran</h2>
              ...
              <div className="space-y-2 p-4 rounded-2xl bg-slate-50 border border-slate-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase text-indigo-900">A. Pendahuluan</span>
                  <Input
              ...
              <div className="space-y-2 p-4 rounded-2xl bg-indigo-50/50 border border-indigo-100">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase text-indigo-900">B. Kegiatan Inti</span>
                  <Input
              ...
              <div className="space-y-2 p-4 rounded-2xl bg-slate-50 border border-slate-200">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black uppercase text-indigo-900">C. Penutup & Refleksi</span>
                  <Input
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
              <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900">Asesmen Karakter & Penandatangan</h2>
                  <p className="text-xs text-slate-500">Teknik evaluasi sikap, rubrik observasi, serta pengesahan kepala & guru</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Penilaian Sikap Karakter</label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Penilaian Pengetahuan</label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Penilaian Keterampilan</label>
                  <Textarea
                    rows={2}
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-3 border-t border-slate-100">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Tempat Titimangsa</label>
                  <Input
