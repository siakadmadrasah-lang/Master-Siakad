...
const CetakRapor = () => {
  ...
  const officialSchoolName = getOfficialMadrasahName(activeMadrasah, settings.identitas_madrasah, 'Si@Kad Madrasah');
              ...
              <div className="grid grid-cols-2 gap-8 mb-8 text-[10pt] font-serif">
                <table className="w-full">
                  <tbody>
                    ...
                    <tr><td className="py-1">Nama Madrasah</td><td>:</td><td className="font-semibold uppercase">{officialSchoolName}</td></tr>
                  </tbody>
                </table>
                <table className="w-full">
                  <tbody>
