...
const LCKH = () => {
  ...
  const handleExportExcel = () => {
    ...
    const worksheetData = [
      ...
      [`Satuan Kerja: ${getOfficialMadrasahName(activeMadrasah, settings.identitas_madrasah, 'Madrasah')}`],
              ...
              <div className="mb-3 text-xs">
                <div className="grid grid-cols-2 gap-x-8 gap-y-1 p-2.5 border border-black bg-slate-50/50 rounded-sm">
                  ...
                  <div className="flex">
                    ...
                    <span className="mr-2 font-bold">:</span>
                    <span className="flex-1 font-semibold">{getOfficialMadrasahName(activeMadrasah, settings.identitas_madrasah, 'Madrasah Ibtidaiyah')}</span>
                  </div>
                  <div className="flex">
