            ...
            <div className="mt-12 grid grid-cols-2 gap-12 text-[11pt] font-serif">
              <div className="text-center">
                ...
                <div className="relative inline-block">
                  ...
                  <p className="font-bold underline">{formatOfficialSignatureName(penandatangan.kepala_nama || '[Nama Kepala]')}</p>
                </div>
              ...
              <div className="text-center">
                ...
                <div className="relative inline-block">
                  ...
                  <p className="font-bold underline">{formatOfficialSignatureName(penandatangan.ketua_panitia_nama || '[Nama Ketua Panitia]')}</p>
                </div>
