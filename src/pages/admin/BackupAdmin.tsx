        ...
        {isSuperAdmin && (
          <Card className="border-0 shadow-xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white overflow-hidden relative rounded-3xl">
            <CardContent className="p-6 md:p-8 space-y-6 z-10 relative">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                  <button 
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold rounded-2xl h-14 px-6 shadow-xl hover:scale-105 active:scale-95 transition-all text-base shrink-0 cursor-pointer text-left"
                    title="Unduh file ZIP cPanel hosting siap pakai (DB: masbagoes_siakad)"
                  >
                    {downloadingZip ? (
                      <>
                        <Loader2 className="w-5 h-5 animate-spin" />
                      ...
                      <>
                        ...
                        <div className="flex flex-col items-start leading-tight">
                          <span>Unduh ZIP cPanel Ready</span>
                          <span className="text-[10px] font-semibold text-emerald-950/70">DB: masbagoes_siakad</span>
                        </div>
                      </>
                    )}
                  </button>
                  ...
                  <button 
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl h-14 px-5 border border-indigo-400/30 hover:scale-105 transition-all text-sm shrink-0 cursor-pointer text-left"
                    title="Unduh file ZIP Plesk hosting (DB: jaenal_siakadmadrasah, User: jaenal_siakadmadrah)"
                  >
                    <Download className="w-4 h-4" />
                    <div className="flex flex-col items-start leading-tight">
                      <span>Unduh ZIP Plesk Ready</span>
                      <span className="text-[10px] font-normal text-indigo-200">DB: jaenal_siakadmadrasah</span>
                    </div>
                  </button>
              ...
              {/* Troubleshooting Plesk 403 Forbidden */}
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-2xl space-y-3 mt-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2 text-amber-300 font-bold text-sm">
                    <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0" />
                    <span>Website Muncul Error "403 Forbidden" di Plesk? Solusi Cepat:</span>
                  </div>
                  <span className="text-[11px] bg-amber-400/20 text-amber-200 border border-amber-400/30 px-2.5 py-0.5 rounded-full font-semibold">
                    Panduan Perbaikan 1 Menit
                  </span>
                </div>
                <div className="grid sm:grid-cols-2 gap-3 text-xs text-slate-200">
                  <div className="bg-black/30 p-3 rounded-xl border border-white/5 space-y-1">
                    <strong className="text-amber-300 block text-xs">1. File Terekstrak di Subfolder (90% Kasus)</strong>
                    <p className="text-slate-300 leading-relaxed text-[11px]">
                      Saat ekstrak zip di Plesk File Manager, pastikan tidak masuk ke dalam subfolder <code className="text-amber-200 bg-white/10 px-1 py-0.5 rounded">httpdocs/siakadmadrasah-plesk-ready/</code>. Masuk ke subfolder itu, klik <strong>Select All</strong> &rarr; <strong>Move</strong> ke folder <code className="text-emerald-300 bg-white/10 px-1 py-0.5 rounded">httpdocs</code> langsung.
                    </p>
                  </div>
                  <div className="bg-black/30 p-3 rounded-xl border border-white/5 space-y-1">
                    <strong className="text-amber-300 block text-xs">2. Izin File & Folder (CHMOD Permissions)</strong>
                    <p className="text-slate-300 leading-relaxed text-[11px]">
                      Folder wajib berizin <strong className="text-white">755</strong> dan file berizin <strong className="text-white">644</strong>. Di File Manager Plesk, pilih semua file &rarr; klik <strong>Change Permissions</strong> agar web server Nginx/Apache dapat membaca file.
                    </p>
                  </div>
                  <div className="bg-black/30 p-3 rounded-xl border border-white/5 space-y-1">
                    <strong className="text-amber-300 block text-xs">3. Cek Document Root di Plesk</strong>
                    <p className="text-slate-300 leading-relaxed text-[11px]">
                      Buka Plesk &rarr; <strong>Websites & Domains</strong> &rarr; <strong>Hosting Settings</strong>. Pastikan kolom <strong>Document root</strong> terisi <code className="text-emerald-300 bg-white/10 px-1 py-0.5 rounded">httpdocs</code> persis tempat file berada.
                    </p>
                  </div>
                  <div className="bg-black/30 p-3 rounded-xl border border-white/5 space-y-1">
                    <strong className="text-amber-300 block text-xs">4. Pastikan PHP Support Aktif</strong>
                    <p className="text-slate-300 leading-relaxed text-[11px]">
                      Buka menu <strong>PHP Settings</strong> di domain Anda pada Plesk, pastikan <strong>PHP Support</strong> dicentang aktif (versi PHP 8.1, 8.2, atau 8.3 dengan handler FPM). File <code className="text-sky-300 bg-white/10 px-1 py-0.5 rounded">.htaccess</code> terbaru juga sudah otomatis menyertakan izin Apache 2.4 (<code className="text-emerald-300">Require all granted</code>).
                    </p>
                  </div>
                </div>
              </div>
