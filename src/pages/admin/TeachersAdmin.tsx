...
import { downloadExcelWithDropdowns } from '@/utils/excelTemplateHelper';
    ...
    reader.onload = async (evt) => {
      try {
        ...
        formattedRows.forEach((row, idx) => {
          ...
          const tanggal_lahir = getVal(['Tanggal Lahir (YYYY-MM-DD)', 'Tanggal Lahir', 'tanggal_lahir', 'Tgl Lahir', 'Tgl. Lahir', 'tgl_lahir', 'Tgl Lahir Guru', 'Tanggal']);
          const tmt_pendidik = getVal(['TMT Pendidik', 'TMT', 'tmt_pendidik', 'TMT Guru', 'TMT Awal Pendidik', 'TMT Awal']);
          const tmt_madrasah = getVal(['TMT Madrasah', 'TMT Satminkal', 'tmt_madrasah', 'TMT Sekolah', 'TMT Tugas di Madrasah', 'TMT Tugas Satminkal']);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-emerald-900 via-teal-900 to-slate-900 text-white p-6 rounded-3xl shadow-xl">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-200 border-emerald-400/40 rounded-2xl gap-1.5 text-xs font-bold shadow-sm"
            >
              <FileSpreadsheet className="w-3.5 h-3.5 text-emerald-300" /> Sync Google Sheet
            </Button>
            <Button
