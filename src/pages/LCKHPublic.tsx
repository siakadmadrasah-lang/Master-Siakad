              ...
              <div className="mb-6 text-xs">
                <div className="grid grid-cols-2 gap-x-8 gap-y-2 p-3.5 border border-black bg-slate-50/50 rounded-sm">
                  ...
                  <div className="flex">
                    ...
                    <span className="mr-2 font-bold">:</span>
                    <span className="flex-1 font-semibold">{getOfficialMadrasahName(activeMadrasah, settings.identitas_madrasah, settings.general?.school_name || 'Madrasah Ibtidaiyah')}</span>
                  </div>
                  <div className="flex">
