...
import { 
  ...
  Clock, MapPin, Info, Sparkles, BookOpen, Bell, Printer
} from 'lucide-react';
...
import CetakKalender from '@/components/CetakKalender';
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-sm md:text-base">
              Pantau seluruh jadwal kegiatan, hari libur, dan agenda penting madrasah dalam satu tampilan interaktif.
            </p>

            <div className="pt-2 flex justify-center">
              <Button
                onClick={() => setIsPrinting(true)}
                className="h-12 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl px-6 font-bold shadow-lg flex items-center gap-2"
              >
                <Printer className="w-4 h-4" /> Cetak Kalender Akademik
              </Button>
            </div>
          </div>
