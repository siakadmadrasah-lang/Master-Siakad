...
import { Languages, ArrowRightLeft, Loader2, Copy, Check, Sparkles, Globe, ArrowLeft, Home } from 'lucide-react';
...
const Translator = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="pt-28 pb-20 px-4 md:px-6 max-w-6xl mx-auto space-y-6">
