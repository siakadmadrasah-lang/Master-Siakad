...
const CoverGeneratorPublic = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    nama_madrasah: (activeMadrasah as any)?.nama_resmi || settings.identitas_madrasah?.nama_resmi || (activeMadrasah as any)?.nama_madrasah || activeMadrasah?.nama || settings.identitas_madrasah?.nama_madrasah || settings.general?.school_name || 'Si@Kad Madrasah',
