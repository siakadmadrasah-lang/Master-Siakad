    ...
    from: (tableName: string) => {
      ...
      const builder: any = {
        ...
        then: async (resolve: any, reject?: any) => {
          if (isDelete) {
            ...
            if (typeof window !== 'undefined') {
              window.dispatchEvent(new CustomEvent('siakad_settings_updated', { detail: { tableName, isDelete: true, ids: idsToDelete } }));
        ...
        upsert: async (payload: any) => {
          ...
          if (typeof window !== 'undefined') {
            window.dispatchEvent(new CustomEvent('siakad_settings_updated', { detail: { tableName, payload } }));
            window.dispatchEvent(new Event('siakad_identitas_updated'));
